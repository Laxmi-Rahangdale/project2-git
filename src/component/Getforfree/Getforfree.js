...
const Getforfree = () => {
  ...
  return (
    ...
    <div className="container " style={{ backgroundColor: "black",height:100, width:"100%"}}>
    <div>
      ...
      <Image className="img-fluid d-none d-md-inline" src="./Vector1.png"   style={{position:'relative',left:10,top:15}}/>
